...
function PANEL:Init()
    ...
    self.TitleLabel:SetText( "Jailer Menu" )
    ...
    self.CloseButton.DoClick = GlorifiedHandcuffs.UI.CloseJailerMenu
end
...
vgui.Register( "GlorifiedHandcuffs.JailerMenu.TitleBar", PANEL, "Panel" )